...
<link href="ht	tp://fonts.googleapis.com/css?family=Open+Sans:400,700,800,600,300" rel="stylesheet" type="text/css">
  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="login" style="margin-left: -100px" class="btn btn-sm btn-default">login</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="intro-text">
            <p>Selamat Datang</p>
            <h2>Sistem Informasi Laporan Harian Warroom  <span class="brand">SILHW</span></h2>
            <p>Sistem ini berguna untuk Membantu Pembuatan Laporan Harian Bagian Warroom</p>
        </div>
      </div>
    </div>
  </div>
...
<script type="text/javascript" src="{{asset('homepage/js/contact_me.js')}}"></script> 
